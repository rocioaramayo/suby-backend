...
public class UserProductController {
    ...
    public ResponseEntity<?> registerOwnerProduct(
            ...
            @RequestParam(value = "deposit_id", required = false) Integer depositId,
            @RequestParam(value = "preferred_currency", required = false) String preferredCurrency,
            @RequestParam(value = "accepts_usd", required = false) Boolean acceptsUsd,
